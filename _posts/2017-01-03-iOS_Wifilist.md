...
- (void)getWifiList {
	...
	dispatch_queue_t queue = dispatch_queue_create("com.makeclan.HotspotHelper", 0);
...
<br>
转载请注明：[何去丶何从的博客](http://baixin) » [Wifi 定位原理及 iOS Wifi 列表获取](http://baixin.io/2017/01/iOS_Wifilist/)  
